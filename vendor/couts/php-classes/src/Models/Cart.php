...
class Cart extends Model
{
        ...
        if (isset($_SESSION[Cart::SESSION]) && (int)$_SESSION[Cart::SESSION]['idcart'] > 0) {
            ...
            if (!(int)$cart->getidcart() > 0) {
                ...
                if (User::checkLogin(false)) {
                    ...
                    $data['iduser'] = (int)$user->getiduser();
                }
    ...
    public function getFromSessionId()
    {
        ...
        $results = $sql->select("SELECT * FROM tb_carts WHERE dessessionid = :  ", [
            ":dessessionid" => session_id()
        ]);
    ...
    public function store()
    {
        ...
        $data = $sql->select("CALL sp_carts_save(:idcart, :dessessionid, :iduser, :deszipcode, :vlfreight, :nrdays)", [
    ...
    public function addProduct(Product $product)
    {
        ...
        $sql->query("INSERT INTO tb_cartsproducts (idcart, idproduct) VALUES (:idcart, :idprouduct)", [
            ":idcart" => $this->getidcart(),
            ":idprouduct" => $product->getidproduct()
        ]);
