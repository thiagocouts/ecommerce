<?php if(!class_exists('Rain\Tpl')){exit;}?><form method="post" action="https://pagseguro.uol.com.br/v2/checkout/payment.html">  
    ...
    <!-- Campos obrigatórios -->  
    <input name="receiverEmail" type="hidden" value="thiagogc1987@gmail.com">  
    ...
    <input name="senderAreaCode" type="hidden" value="<?php echo htmlspecialchars( $phone["areCode"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">  
